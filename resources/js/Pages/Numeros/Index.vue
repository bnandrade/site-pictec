    ...
    <app-layout>
        <div class="w-full">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <new-numero  v-if="formNewVisible" class="mb-10"></new-numero>
                <list-numeros :numeros="numeros" :filters="filters"
                               v-if="$page.props.auth.user.can['numero-listar'] || $page.props.auth.user.role['Super.Admin']"></list-numeros>
                <button v-else
...
import NewNumero from "./New"
import ListNumeros from "./List"
